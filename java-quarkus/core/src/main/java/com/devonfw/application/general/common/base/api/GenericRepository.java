...
/**
 * {@link JpaRepository} with {@link QueryDslSupport} as well as typical devon4j
 * standard operations. It is recommended
...
public interface GenericRepository<E, ID extends Serializable>
  ...
  /**
   * @param ids the {@link Collection} of
   *            {@link com.devonfw.module.basic.common.api.entity.PersistenceEntity#getId()
   *            IDs} to delete.
