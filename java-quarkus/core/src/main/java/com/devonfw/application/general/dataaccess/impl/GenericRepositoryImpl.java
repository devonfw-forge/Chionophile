...
/**
 * Implementation of {@link GenericRepository} based on
 * {@link SimpleJpaRepository}. All repository interfaces derived
 * from {@link GenericRepository} will be based on this implementation at
 * runtime.<br>
 * <b>Note:</b> We do not use/extend {@code QuerydslJpaRepositor} as it forces
 * you to use QueryDSL APT generation what
 * is not desired. Therefore, you will have no support for
 * {@code QueryDslPredicateExecutor}. However, we offer more
 * flexible QueryDSL support anyhow. See
 * {@link com.devonfw.module.jpa.dataaccess.api.data.QueryDslSupport}.
 *
 * @param <E>  generic type of the managed {@link #getEntityClass() entity}.
 * @param <ID> generic type of the
 *             {@link com.devonfw.module.basic.common.api.entity.PersistenceEntity#getId()
 *             primary key}
 *             of the entity.
 *
 * @since 3.0.0
