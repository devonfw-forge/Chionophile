// package com.devonfw.application.general.common.impl.config;
...
// // e.g. when the service has been updated/extended but the calling REST
// client is not yet updated
// // see
