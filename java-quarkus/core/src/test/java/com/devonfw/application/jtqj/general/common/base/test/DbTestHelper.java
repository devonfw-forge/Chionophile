...
/**
 * This class provides methods for handling the database during testing where
 * resets (and other operations) may be
 * necessary.
 */
@Named
public class DbTestHelper {
  ...
  /**
   * Calls {@link #dropDatabase()} internally, and migrates to the highest
   * available migration (default) or to the
