...
/**
 * This test verifies that the entire code of your code-base is located in
 * {@link Devon4jPackage#isValid() valid Devon4j
 * packages}.
 */
public class Devon4jPackageCheckTest extends ModuleTest {

  /**
   * Scans all the packages of this application root pacakge namespace. Will
   ...
   * @return the root package to scan for {@link Class}es to get the actual
   *         packages to check.
   */
