...
public class PermissionCheckTest extends ModuleTest {
  ...
  /**
   * Check if all relevant methods in use case implementations have permission
   * checks i.e. {@link RolesAllowed},
   * {@link DenyAll} or {@link PermitAll} annotation is applied. This is only
   * checked for methods that are declared in
   * the corresponding interface and thus have the {@link Override} annotations
   * applied.
   */
  @Test
  @Disabled
  public void permissionCheckAnnotationPresent() {
    ...
    String packageName = "com.devonfw.application";
