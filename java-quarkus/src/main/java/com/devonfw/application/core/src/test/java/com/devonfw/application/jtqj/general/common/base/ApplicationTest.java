...
import com.devonfw.application.general.common.base.test.ApplicationComponentTest;
import com.devonfw.application.general.dataaccess.api.ApplicationPersistenceEntity;

/**
 * This test verifies that {@link com.devonfw.application.SpringBootApp} is able
 * to startup.
 */
public class ApplicationTest extends ApplicationComponentTest {
  ...
  public void testContextLoads() {
    ...
    entity.setId(id);
    // when
    MyEto eto = this.beanMapper.map(entity);
    // then
