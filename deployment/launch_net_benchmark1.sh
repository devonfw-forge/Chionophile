...
# Check if net_benchmark1 directory exists
if [ ! -d "net_benchmark1" ] && cd .. && [ ! -d "net_benchmark1" ] ; then
    err_msg="[ERROR] net_benchmark1 directory does not exists."
    err_display
fi
...
cp ../benchmarks/net_benchmark1/PowerLog.csv $save_file
rm ../benchmarks/net_benchmark1/PowerLog.csv

cp ../benchmarks/net_benchmark1/report.html $report_file
rm ../benchmarks/net_benchmark1/report.html
